...
module.exports = {
    ...
    check_account_status: async function (account, fs, rpc, RpcError) {
        /*
        ...
        try {
            ...
            if ("abi" in accountAbi) { // Account already has contract applied.
                ...
                if (!_.isEqual(accountAbi.abi.actions,repoAbi.actions) ||
                    ...
                    // We don't want to over-write their data, so we ask them to use a new account.
                    return 5;
                } else {
                    return 1;
                }
        ...
        return 3; // Default to 3 for testing
